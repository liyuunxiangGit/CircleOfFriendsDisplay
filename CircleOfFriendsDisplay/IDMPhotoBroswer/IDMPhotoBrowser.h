...
// IDMPhotoBrowser
@interface IDMPhotoBrowser : UIViewController <UIScrollViewDelegate, LCActionSheetDelegate>
...
@property (nonatomic) BOOL displayUseButton;
@property (nonatomic) BOOL useWhiteBackgroundColor;
@property (nonatomic, weak) UIImage *doneButtonImage;
@property (nonatomic, weak) UIImage *useButtonImage;
@property (nonatomic,copy) NSString *useButtonTitle;
